...
import PlatformsMountain from "../objects/PlatformsMountain";
import BG from "../assets/bg2.png";
import EnemyTest from "../objects/EnemyTest";
import FloorMountain from "../objects/FloorMountain";
...
export default class StageTwo extends React.Component {
  ...
  handleVictory = () => {
    ...
    this.props.navigation.replace("StageThree", {
