...
![Tela Home](./img/HomeScreen.png)![Primeiro Estágio](./img/StageOne.png)![Segundo Estágio](./img/StageTwo.png)![Terceiro Estágio](./img/StageThree.png) ![Tela Game Over](./img/GameOver.png) ![Tela de Vitória](./img/VictoryScreen.png)

# Gifs do Jogo

<h2>Exemplo de uma Full Run:
<img src="./img/fullrun.gif" alt="run" width="400" height="700"/>
</h2>
<h2>Exemplo de colisão:
